...
def play(level, shreyansh, freyam):
    counter = 0
    arr = [[
 ...
 ╚████╔╝ ██║   ██║██║  ██║██║  ██║███████║ ╚═╝       ██║   ███████║█████╗      ██║██╔██╗ ██║██║     █████╗  ██████╔╝   ██║   ██║██║   ██║██╔██╗ ██║
  ╚██╔╝  ██║   ██║██║  ██║██║  ██║██╔══██║ ██╗       ██║   ██╔══██║██╔══╝      ██║██║╚██╗██║██║     ██╔══╝  ██╔═══╝    ██║   ██║██║   ██║██║╚██╗██║
   ...
   ╚═╝    ╚═════╝ ╚═════╝ ╚═════╝ ╚═╝  ╚═╝           ╚═╝   ╚═╝  ╚═╝╚══════╝    ╚═╝╚═╝  ╚═══╝ ╚═════╝╚══════╝╚═╝        ╚═╝   ╚═╝ ╚═════╝ ╚═╝  ╚═══╝
    ...
    # print(freyam)
    # print(len(shreyansh))
    def check_symbol(shreyansh, freyam):
        # print("Here")
        # input()
        if shreyansh[freyam] == None:
            # print("Done")
            # input()
            freyam += 1
            check_symbol(shreyansh, freyam)
            print("Here " + str(freyam))
            return freyam
        else:
            return freyam
    
    freyam = check_symbol(shreyansh, freyam)
    # print("There " + str(freyam))
    # input()

    print(shreyansh[freyam])
    symbol = shreyansh[freyam]
    # print(symbol)
    # input()
    freyam += 1
    ...
    if(Buildings):
        ...
        if level < 3:
            play(level + 1, shreyansh, freyam)
        elif level == 3:
            exit()

with open ('replay/replay.json', 'r') as f:
    datascore = json.load(f)
    print(str(len(datascore)) + " games played")
replaygame = int(input("Enter game number you want to replay: "))
with open ('replay/replay.json', 'r') as f:
    data = json.load(f)
    if replaygame > len(data):
        print("Game doesn't exist")
        exit()

    shreyansh = data[replaygame-1]    
    play(1, shreyansh, 0)